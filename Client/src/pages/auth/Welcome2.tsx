  ...
  return (
    <div className="flex flex-col h-screen items-center justify-between bg-white">
      ...
      <div className="flex flex-col items-center justify-center p-5">
        <img src={onboarding[1].image} style={{ height: 350 , objectFit: "contain" }}/>
        <div className="flex flex-row items-center justify-center w-full mt-10">
          <p className="text-black text-[26px] font-bold mx-10 text-center">{onboarding[1].title}</p>
        </div>
          <p className="text-base font-SemiBold text-center text-[#858585] mx-10 mt-3">{onboarding[1].description}</p>
      </div>

      <CustomButton 
        title={"Next"} 
        onPress={() => navigate("/welcome3")}
